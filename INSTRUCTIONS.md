...
- <a href="#getblockchaininfo">getblockchaininfo</a>
- <a href="#getbestblockhash">getbestblockhash</a>
- <a href="#getblockhash">getblockhash</a>
- <a href="#calc_MoM">calc_MoM</a>
- <a href="#validateaddress">validateaddress</a>
- <a href="#getblock">getblock</a>
- <a href="#listunspent">listunspent</a>
- <a href="#get_notarizaion_data">get_notarization_data</a>
- <a href="#sendrawtransaction">sendrawtransaction</a>
- <a href="#decoderawtransaction">decoderawtransaction</a>
- <a href="#signrawtransaction">signrawtransaction</a>
...
<h4 id="getblockchaininfo">getblockchaininfo:</h4>
...
<h4 id="getbestblockhash">getbestblockhash</h4>
...
<h4 id="getblockhash">getblockhash</h4>
...
<h4 id="validateaddress>validateaddress</h4>
...
<h4 id="listunspent">listunspent</h4>

Parameters: `[ minconf, maxconf, ["address"] ]`
...
<h4 id="sendrawtransaction">sendrawtransaction</h4>

Parameters: `[ "raw_tx_hex" ]`
...
<h4 id="decoderawtransaction">decoderawtransaction</h4>

Parameters: `[ "raw_tx_hex" ]`

```
curl --data-binary '{"jsonrpc":"1.0", "id":"curltest", "method":"decoderawtransaction", "params":["xxxxxxxxxxxxxx"]}' http://localhost:8383
```

Response:

```
{"error":null,"id":"curltest","result":{"txid":"bd1f122c6061a6db1f732900b06a67d1abc4c7fd863521133442be09536bcde6","vin":[{"scriptSig":{"hex":"21037db090cbbe154b7e0a0742032208250537e42ad822968cd5419ce5913a4d8afbac"},"txid":"bd1f122c6061a6db1f732900b06a67d1abc4c7fd863521133442be09536bcde6"},{"scriptSig":{"hex":"21026b2a11cb90960c59a9d46d2fb31819767af15edcd0b4c32cfb43895d341d8d1eac"},"txid":"bd1f122c6061a6db1f732900b06a67d1abc4c7fd863521133442be09536bcde6"}],"vout":[{"scriptPubKey":{"hex":"21037db090cbbe154b7e0a0742032208250537e42ad822968cd5419ce5913a4d8afbac"}},{"scriptPubKey":{"hex":"21026b2a11cb90960c59a9d46d2fb31819767af15edcd0b4c32cfb43895d341d8d1eac"}}]}}
```

---

<h4 id="signrawtransaction">signrawtransaction</h4>

Parameters: `["raw_tx_hex", [ { "input_extry1" }, { "input_entry2" }]]

```
curl --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "signrawtransaction", "params":["",[{"txid":"xxxxxxxxxx","vout":40,"amount":0.0001,"scriptPubKey":"21037db090cbbe154b7e0a0742032208250537e42ad822968cd5419ce5913a4d8afbac"},{"txid":"xxxxxxxxxx","vout":40,"amount":0.0001,"scriptPubKey":"21026b2a11cb90960c59a9d46d2fb31819767af15edcd0b4c32cfb43895d341d8d1eac"}]]}' http://localhost:8383
```

Response:

```
{"error":null,"id":"curltest","result":{"complete":true,"hex":"","status":"OK"}}
```
